...
- [x] Password-gated admin login + dashboard (approve/reject/revoke creator requests) with `SITE_PASSWORD`/`SESSION_SECRET` secrets
...
- [x] Replace teacher magic link with a request password and secure approved creator sign-in
